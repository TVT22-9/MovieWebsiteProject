...
const sql = {
    ...
    GET_REVIEW_BY_USERNAME: 'SELECT reviews.idreview, reviews.iduser, reviews.idmovie, reviews.idseries, reviews.reviewcontent, reviews.score, TO_CHAR(reviews.reviewtimestamp, \'DD.MM.YYYY HH24.MI\') AS reviewtimestamp, webusers.username FROM reviews INNER JOIN webusers ON reviews.iduser = webusers.iduser WHERE webusers.username = ANY($1) ORDER BY reviews.reviewtimestamp DESC',
