...
*/
async function AddReview(iduser, idmovie, idseries, reviewcontent, score) {
    console.log(iduser, idmovie, idseries, reviewcontent, score);
    let result = await pgPool.query(sql.ADD_REVIEW, [iduser, idmovie, idseries, reviewcontent, score]);
    return result.rowCount > 0 ? result.rows : null;
}
